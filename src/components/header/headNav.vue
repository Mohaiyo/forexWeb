<template>
	<div class="nav">
		<div class="nav-inner">
			...
			<div ><a class="login" href="http://www.jin10.com">市场数据</a></div>
		</div>
	</div>
</template>
<script>
